...
const JO = () => {
  const InView = () => {
    ...
    const { ref, inView, entry, rootMargin } = useInView({
      threshold: 0,
      initialInView: false,
      rootMargin: '100% 0% -40% 0%',
      // rootMargin: '-50px 0px 10px 0px', // good
    })

    return (
      <div className='bg-white flex flex-col border-r-32 h-[60vh] border-l-32 border-black border-solid duration-700'>
        ...
        <div
          className={`bg-white transition-opacity ease-in-out duration-700 lgmt-20  ${
